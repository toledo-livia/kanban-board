...
import LightOnIcon from '../../common/assets/light-on.png';
import LightOffIcon from '../../common/assets/light-off.png';
        ...
        <Header>
          <TitleAndSwitch>
            ...
            <Switch
              ...
              checked={title === 'light'}
              checkedIcon={<SwitchIcon src={LightOnIcon} alt="Sun"/>} 
              uncheckedIcon={<SwitchIcon src={LightOffIcon} alt="Moon"/>} 
